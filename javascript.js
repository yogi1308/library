...
function Book(title, author, status, length, lengthType, cover, synopsis, favorite) {
  // the constructor...
  this.title = title
  this.author = author 
  this.status = status
